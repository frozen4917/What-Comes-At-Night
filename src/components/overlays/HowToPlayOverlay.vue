            ...
            <div class="guide-text">
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <ul>
                            <li>
                                <span class="subpoint">Show Inventory:</span> Look at the items you have leftover in your inventory.
                            </li>
                            <li>
                                <span class="subpoint">Options:</span> Control the volume, in case the music is too loud.
                            </li>
                            <li>
                ...
                <ul>
                    ...
                    <li>
                        <strong class="point">Bosses:</strong> Stronger enemies with special abilities. Kill them fast.
                    </li>
                </ul>

                <h3>Phases</h3>
                <ul>
                    <li>The game comprises of 50 moves spread across 7 phases.
                        <ul>
                            <li><span class="dusk">Dusk</span> and <span class="evening">Evening</span> are the exploration phases. Use this time scavenge for resources and fortify your defenses. Be careful, if you create too much noise, lone monsters might wander towards you.</li>
                            <li><span class="nightfall">Nightfall</span> and <span class="deep_night">Deep Night</span> is when darkness takes over. Small hordes will begin to spawn. You cannot hide from them!</li>
...
.overlay-content {
    ...
    overflow-y: auto;
    text-align: left; /* Easier to read blocks of text */
